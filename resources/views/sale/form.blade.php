...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('sale.update', $product->id)}}" id="create_product" method="POST">
                @csrf
                <div class="row">
                    <div class="form-group col-md-4">
                        <label for="name_product">Nombre de producto</label>
                        <input type="text" disabled name="name_product" class="form-control" value="{{ $product->name_product }}"
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="number" disabled name="price" class="form-control" value="{{ $product->price }}"
                               placeholder="Ingrese el Precio del producto">
                    </div>

                    <div class="form-group col-md-4">
                        <label for="weight">Peso del producto</label>
                        <input type="number" name="weight" disabled class="form-control" value="{{ $product->weight }}"
                               placeholder="Ingrese el Peso del producto">
                    </div>

                    <div class="form-group col-md-4">
                        <label for="category">Categoría</label>
                        <input type="text" disabled name="category" class="form-control" value="{{ $product->category }}"
                               placeholder="Ingrese la Categoría del producto">
                    </div>

                    <div class="form-group col-md-4">
                        <label for="stock">Stock del producto</label>
                        <input type="number" disabled name="stock" class="form-control" value="{{ $product->stock }}"
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="number" required="true" name="quantity" class="form-control"
                               placeholder="Ingrese la cantidad del producto a vender">
                    </div>
                </div>
